...
obsluga_zegara PROC
    ...
    ; Decrese "timer" stored in cx and check whether this interrupt should be skipped
    dec cx      ; Decrese timer by one
    cmp cx, 0   ; Check if timer is 0
    jne koniec  ; If no skip executing clock interrupt

    mov cx, 18  ; if yes, reset timer and execute clock interrupt
    ...
    mov byte PTR es:[bx+1], 00010110B ; kolor w formacie [MRGBIRGB] - pierwsze RGB = kolor tła, drugie RGB = kolor znaku
...
mov cx, 18      ; Set clock interrupt timer
